...
namespace CrozzleApplication
{
    public partial class CrozzleViewerForm : Form
    {
        ...
        public CrozzleViewerForm()
        {
            ...
            // Add default URLs
            URL.Items.Clear();
            URL.Items.Add("http://sit323.azurewebsites.net/Task2/Test1-Crozzle.txt");
            URL.Items.Add("http://sit323.azurewebsites.net/Task2/Test2-Crozzle.txt");
            URL.Items.Add("http://sit323.azurewebsites.net/Task2/Test3-Crozzle.txt"); 
            URL.Items.Add("http://sit323.azurewebsites.net/Task2/Example1-Crozzle.txt");
